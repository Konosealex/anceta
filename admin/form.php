...
//хэш
$userHash = md5($sexFilter . $lastNameFilter . $nameFilter . $thirdNameFilter . $birthDateFilter); //записывать хэшг в бд каждому юзеру и обращаться к файоам уже через него
//фильтры
